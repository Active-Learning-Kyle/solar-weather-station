...
- at least one exact candidate point has been walked with responsible site staff;
- the managing unit and exact approval route are identified;
- permitted mounting, duration, footprint, access and safe-removal arrangements are recorded;
- public/fall/electrical/weather/security blockers are resolved or the point is rejected;
- environmental and network limitations are documented;
- written permission is linked or its required next approval is explicit; and
