...
| OPS-002 | Field operators shall receive a concise three-stage quick checklist with observable `yes / no / not applicable` checks, explicit immediate-stop actions and links to the full evidence record, anomaly guide and escalation contacts. | VAL-002 Gate B walkthrough Q1 and Q6 | Independent TA usability dry run; T-077 | Draft pack created; independent TA validation pending |
...
| OPS-004 | The first complete deployment cycle shall record actual bench, installation, initial-confirmation, daily-check, dashboard-review, removal and post-retrieval durations plus TA interventions before the workflow is scaled to additional teams. | VAL-002 Gate B walkthrough Q2 | Timed independent workflow trial; T-077 | Planning estimates recorded; actual trial pending |
