...
| Solution landscape | First comparison plus Gate A instructor and Gate B [TA interviews](docs/project-journey/stakeholder-validation-record.md) completed; Gate C [pre-walk requirements and site pack](tests/site-validation-pack/README.md) drafted | Complete the responsible-staff site walk/approval and supervised TA workflow trial; then reference/quotation, tabletop and stakeholder re-scoring before concept lock |
