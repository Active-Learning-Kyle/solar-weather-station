...
| Solution landscape | First comparison and Gate A completed; Gate B [TA-perspective workflow](docs/project-journey/stakeholder-validation-record.md) and [operations pack](tests/field-operations-pack/README.md) drafted | Confirm with an independent TA dry run; complete site, reference/quotation, tabletop and stakeholder re-scoring before concept lock |
